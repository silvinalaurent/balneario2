...
import '../imports/rad-boton.js';

class RADBotonexcel extends PolymerElement {
  static get template() {
    return html`
      ...
      <rad-boton on-click="_generaexcel">
    ...
    this.myExcelXML = (function() {
      ...
      const myXMLTable = function(o) {
          ...
          if (tableData.length > 0) {
              ...
              TableStart+='<ss:Row></ss:Row><ss:Row ss:StyleID="1"><ss:Cell><ss:Data ss:Type="String">'+replaceAll(fileName,"_"," ")+'</ss:Data></ss:Cell></ss:Row>';
              TableStart+='<ss:Row ss:StyleID="1"><ss:Cell><ss:Data ss:Type="String">'+subTitulo+'</ss:Data></ss:Cell></ss:Row><ss:Row></ss:Row>';
  ...
  _generaexcel(){
    var excel = new this.myExcelXML(JSON.stringify(this.elementos));
    var nombrearchivo = replaceAll(this.titulo," ","_");
    excel.fileName = nombrearchivo;
    excel.subTitulo = this.subtitulo
    excel.downLoad();
  };
  
}

window.customElements.define('rad-boton-excel', RADBotonexcel);