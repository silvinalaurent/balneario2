...
if ($accion==1) {
	...
	$query.="insert into pagos (fecha,idestadia, forma_pago, importe, idusuario, estado,fecha_hora) values ('$fecha',0,'E','$monto','$idusuario','N','$fechaHora')";
