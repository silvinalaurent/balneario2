...
*/
function lista_adicionales(nombreselector) {
      $("#"+nombreselector).append('<option value="0">Ninguno</option>');
      $.ajax({
                  
                      type: "POST",
                      url:"../adicionales/adicionales.php",
                      ...
                      success: function(adicionales){
                          ...
                          for (var i in adicionales){
                              var unadicional = adicionales[i];
                              
                              $("#"+nombreselector).append('<option value="'+unadicional.id+'">'+unadicional.detalle+' $ '+unadicional.importe+'</option>');
...
function cambiaadicional(idadicional){
...
if (idadicional!=0)
  {
      $.ajax({
                      type: "POST",
                      url:"../adicionales/adicionales.php",
                      data: {accion:4, operacion:1, caracteres:idadicional},
                      dataType: "json",
                      async: true,
                      success: function(adicionales){
 
                              var unadicional = adicionales[0];
                              document.getElementById("adicional").value=unadicional.importe;
                              calculaestadia();
      ...
      document.getElementById("adicional").value=0;
      calculaestadia();
    };    
};

function cambiaadicional2(idadicional)
{
  if (idadicional!=0)
  {
      $.ajax({
                      ...
                      success: function(adicionales){
                              ...
                              var unadicional = adicionales[0];
                              document.getElementById("adicional2").value=unadicional.importe;
                              calculaestadia();
      ...
      document.getElementById("adicional2").value=0;
      calculaestadia();
    }; 
};
