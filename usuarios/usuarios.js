                      ...
                      success: function(usuarios){
                          ...
                          for (var i in usuarios){
                           ...
                           if (i >= 0)
                           {
                              ...
                              $("#tabla tbody").append("<tr><td>" + unusuario.usuario + "</td><td><a href='#' onclick='modifica_usuario("+JSON.stringify(unusuario)+")'><i class=\"icon-pencil\"></i></a> - <a href='#' onclick='modifica_clave("+JSON.stringify(unusuario)+")'><i class=\"icon-key\"></i></a> </td> </tr>"); 
                              //21-11 quito la opcion de eleminar usuario porque si ya ha realizado acciones quedan huerfanas
                              /*- <a href='#' onclick='borra_usuario("+unusuario.id+")'><i class=\"icon-trash\"></i></a> */
                           } 
                          }; 
                      },
...
function nombre_usuario(id) {
    return new Promise(function(resolve, reject) {
      $.ajax({
                      ...
                      type: "POST",
                      url:"../usuarios/usuarios.php",
                      data: {accion:4, operacion:6, caracteres:id},
                      dataType: "json",
                      async: false,
                      success: function(usuarios){
 
                              var unusuario = usuarios[0];
                              console.log("usuario ",unusuario);
                              console.log("Usuario buscado ",unusuario.usuario);
                              resolve(unusuario.usuario); 
                      },
                      error: function (obj, error, objError){
